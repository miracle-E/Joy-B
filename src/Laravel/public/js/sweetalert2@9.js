!(function(t, e) {
    ...
    var ct,
        ...
        ft = function(t) {
            ...
            if (ot()) v("SweetAlert2 requires document to initialize");
                ...
                (o.className = _.container),
                    n && st(o, _["no-transition"]),
                    (o.innerHTML = pt);
                var i,
                    r,
                    a,
                ...
                g.appendChild(o),
                    ...
                    (a = W()).setAttribute(
                        "role",
                        r.toast ? "alert" : "dialog"
                    ),
                    a.setAttribute(
                        "aria-live",
                        r.toast ? "polite" : "assertive"
                    ),
                    ...
                    (u = lt(s, _.input)),
                    (l = lt(s, _.file)),
                    (d = s.querySelector(".".concat(_.range, " input"))),
                    (p = s.querySelector(".".concat(_.range, " output"))),
                    (f = lt(s, _.select)),
                    (m = s.querySelector(".".concat(_.checkbox, " input"))),
                    (h = lt(s, _.textarea)),
                    (u.oninput = it),
                    (l.onchange = it),
                    (f.onchange = it),
    ...
    function St(t, s) {
        ...
        X(u), (u.innerHTML = "");
        var l = parseInt(
            void 0 === s.currentProgressStep ? Et() : s.currentProgressStep
        );
