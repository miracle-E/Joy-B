        ...
        @section('content')
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('front/styles/product.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('front/styles/product_responsive.css') }}">
        @if (session('status'))
