...
@section('content')
<link rel="stylesheet" type="text/css" href="{{ URL::asset('front/styles/checkout.css') }}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('front/styles/checkout_responsive.css') }}">
@if (session('status'))
