		...
		<div class="products">
			<div class="container">
						...
						<div class="products_bar d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-start justify-content-center">
							...
							<div class="products_bar_side d-flex flex-row align-items-center justify-content-start ml-lg-auto">
								...
								<div class="product_view d-flex flex-row align-items-center justify-content-start">
									<div class="view_item active"><img src="{{ URL::asset('front/images/view_1.png') }}" alt=""></div>
									<div class="view_item"><img src="{{ URL::asset('front/images/view_2.png') }}" alt=""></div>
									<div class="view_item"><img src="{{ URL::asset('front/images/view_3.png') }}" alt=""></div>
								</div>
				...
				<div class="row products_row products_container grid">
					...
					<div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="{{ URL::asset('front/images/product_7.jpg') }}" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
					...
					<div class="col-xl-4 col-md-6 grid-item new">
						<div class="product">
							<div class="product_image"><img src="{{ URL::asset('front/images/product_8.jpg') }}" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
					...
					<div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="{{ URL::asset('front/images/product_9.jpg') }}" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
